...
from apps.users.models import CustomEmailUser


class CustomEmailUserAdmin(AdminImageMixin, EmailUserAdmin):
    list_display = ('email', 'get_full_name', 'is_staff',)

    def get_fieldsets(self, request, obj=None):
        fieldset_super = super(CustomEmailUserAdmin, self).get_fieldsets(request, obj)
